...
Pong = {
    ...
    Defaults: {
        ...
        ballAccel: 4,     // ... but accelerate as time passes
        ballRadius: 5,
        sound: true
    },
    ...
    initialize: function (runner, cfg) {
        ...
        this.anlik=0;
        this.nesil=1;
        this.GA = new GeneticAlgorithm(10, 4); // EKLEME
        this.GA.reset(); //EKLEME
        this.GA.createPopulation(); //EKLEME
    },
    ...
    start: function (numPlayers) {
        if (!this.playing) {
            ...
            this.leftPaddle = Object.construct(Pong.Paddle, this); //EKLEME
            var tarih = new Date();
            this.ilkzaman = tarih.getTime();
            document.getElementById("nesil").innerHTML = this.nesil+". Nesil Yavrular";
        }
    },
    ...
    stop: function (ask) {
        if (this.playing) {
            if (!ask || this.runner.confirm('Abandon game in progress ?')) {
                ...
                //this.menu.declareWinner(playerNo); //EKLEME
    ...
    goal: function (playerNo) {
        ...
        if (this.scores[playerNo] == 9) {
            ...
            if (this.sayac < 9) {
                ...
                var tarih2 = new Date();
                this.sonzaman = tarih2.getTime();
                this.sure = this.sonzaman - this.ilkzaman;
                this.GA.Population[this.sayac].fitness = this.sure;
                document.getElementById(this.sayac).innerHTML = this.sure/1000+"&nbspsaniye";
                this.sayac += 1;
                this.sonzaman = 0;
                this.ilkzaman = 0;
    ...
    update: function (dt) {
        ...
        if (this.playing) {
            ...
            this.GA.activateBrain(this.ball, this.leftPaddle, this.sayac);
        }

        var tarih6 = new Date(); 
        this.anlik = tarih6.getTime();

        this.toplamsure= this.anlik - this.baslangic;
        document.getElementById("toplamsure").innerHTML = Math.floor(this.toplamsure/60000)+"&nbspdakika";
    ...
    onkeydown: function (keyCode) {
        switch (keyCode) {
            ...
            case Game.KEY.ONE: var tarih5 = new Date(); this.baslangic = tarih5.getTime(); this.startSinglePlayer() ; break;
